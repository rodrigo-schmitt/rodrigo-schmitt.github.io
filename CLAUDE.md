...
- **CSS is append-only from §20**: new sections get new numbers; §27 (reduced-motion) and §28 (print) must stay LAST so their same-specificity overrides win the cascade. Do not edit §18 for new animations — add to §27.
